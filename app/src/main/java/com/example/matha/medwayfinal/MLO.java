...
public class MLO extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        session = Session.getDefaultInstance(props, new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("bunny.mangrani45@gmail.com", "Mathan123");
            }
        });
    ...
    class RetreiveFeedTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                message.setFrom(new InternetAddress("bunny.mangrani45@gmail.com"));
